    ...
    <div class="main-div">
        ...
        <form action="addHome.php" method="POST">
            <label for="houseImgsZip">House photos(.zip):</label>
                <input type="file" name="houseImgsZip" id="houseImgsZip" accept=".zip" required>
            </br>
            <label for="houseImgMain">Main house photo(.jpg/.png):</label>
                <input type="file" name="houseImgMain" id="houseImgMain" accept="image/*" required>
            </br>
            <label for="floorPlan">Floor plans(.pdf):</label>
                <input type="file" name="floorPlan" id="floorPlan" accept=".pdf" required>
            </br>
